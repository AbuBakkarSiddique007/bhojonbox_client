  ...
  if (items.length === 0) {
    return (
      <main className="max-w-4xl mx-auto px-6 py-24 text-center animate-in fade-in duration-1000">
        ...
        <h2 className="text-3xl font-black text-foreground brand uppercase tracking-widest mb-4">Your Cart is Pre-Manifested</h2>
        <div className="w-16 h-1 bg-primary mx-auto mb-6 rounded-full"></div>
        <p className="text-sm text-muted-foreground italic mb-12 max-w-sm mx-auto leading-relaxed">
          The culinary journey begins with a single selection. Explore our curated collections to find your first masterpiece.
        </p>
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-12 lg:py-20 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16 gap-8 text-center md:text-left">
        <div>
          <h1 className="text-5xl font-black text-foreground tracking-tighter brand uppercase mb-4">Culinary Selection</h1>
        ...
        <div className="bg-card border border-border rounded-3xl p-6 shadow-xl relative overflow-hidden group min-w-[200px]">
           ...
           <div className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-1 relative z-10">Absolute Total</div>
            ...
            <section key={pid} className="bg-card border border-border rounded-[2.5rem] p-8 md:p-10 shadow-sm relative overflow-hidden">
               ...
               <div className="flex items-center justify-between mb-8 border-b border-border pb-6 relative z-10">
                  <div className="flex flex-col">
                    <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-1">Provider Consignment</span>
           ...
           <div className="bg-card border border-border rounded-[2rem] p-8 shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="pt-6 border-t border-border/50">
                   <div className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-4">Summary of Engagement</div>
                   <div className="space-y-3">
                      ...
                      <div className="flex justify-between pt-4 border-t border-border/50">
                         <span className="text-[10px] font-black text-foreground uppercase tracking-widest">Total Commitment</span>
